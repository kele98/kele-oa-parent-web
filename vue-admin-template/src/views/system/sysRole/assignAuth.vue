<template>
  <div class="app-container">
    ...
    <div style="padding: 20px 20px;">
      <el-button :loading="loading" type="primary" icon="el-icon-check" size="mini" @click="save" :disabled="$hasBP('bnt.sysRole.add') === false">保存</el-button>
    ...
    */
    getCheckedIds(auths, initArr = []) {
      return auths.reduce((pre, item) => {
        if (item.select === true && item.children == null) {
          console.log(item)
          pre.push(item.id)
